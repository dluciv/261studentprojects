...
imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/home/kate/загрузки.3.jpg"))); // NOI18N
    ...
    public void printError(String error, Position position) {
        ...
        if (position != null) {
            strPosition =
                    "( row: " + (position.getRowNum() + 1) + " column: " + (position.getColumnNumBegin() + 1) + " )";
