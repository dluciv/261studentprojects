...
public class LexerTwo {
    ...
    //public LinkedList<Lexem> getTokenStream() {
    //    return tokenStream;
    //}
    ...
    private boolean ifIdentificator() {
        ...
        if (ifEOF()) {
            ...
            for (String word : dictionary) {
                if (expression.substring(curr_index).startsWith(word)) {
                    ...
                    if (word.equals("->>")) {
                        currLexem = new Lexem(LexemKind.TypeArrow, getPosition());
                    }
                    if (word.equals("unit")) {
            ...
            switch (currChar) {
                ...
                default:
                    ...
                    } else if (ifIdentificator()) {
                        String identificator = getIdentificator();
                        currLexem = new Lexem(LexemKind.Identificator, identificator, getPosition());
                    } else {
                        currLexem = new Lexem(LexemKind.Unknown, '?', getPosition());
                    }
            }
