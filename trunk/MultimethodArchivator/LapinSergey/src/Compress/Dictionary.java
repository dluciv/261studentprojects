...
public class Dictionary {
    ...
    public void TranslateFromOriginal(FileInput str, FileOutput res) throws IOException
    {
        Bits tmp = new Bits();
    ...
    public static void WriteFreqRLE(HashMap<Byte, Integer> freq, FileOutput stream) throws IOException
    {
        Integer pass = (int)Byte.MIN_VALUE;
        int length;
        int currentLength;
    ...
    public static HashMap<Byte, Byte> RestoreDepth(FileInput tmp) throws IOException
    {
    ...
    public static HashMap<Byte, Integer> RestoreFreq(FileInput input) throws IOException
    {
        byte[] bb = new byte[4];
