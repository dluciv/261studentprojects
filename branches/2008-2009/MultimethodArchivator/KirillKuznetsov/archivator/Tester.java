...
public class Tester {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Archivator.archivate("arc",TEST_DIR_PATH + "oneSymbol.txt", TEST_DIR_PATH+"oneSymbol.txt.arc");
        ...
        Archivator.archivate("arc",TEST_DIR_PATH + "Text.txt", TEST_DIR_PATH +"Text.txt.arc");
        //Archivator.archivate("arc",TEST_DIR_PATH + "Text2.txt", TEST_DIR_PATH +"Text2.txt.arc");
        //Archivator.dearchivate(TEST_DIR_PATH + "empty.txt.arc", TEST_DIR_PATH + "empty.arc.txt");
        //Archivator.dearchivate("arc",TEST_DIR_PATH + "oneSymbol.txt.arc", TEST_DIR_PATH + "oneSymbol.arc.txt");
        ...
        //Archivator.dearchivate("arc",TEST_DIR_PATH + "Text.txt.arc", TEST_DIR_PATH+"Text.arc.txt");
        //Archivator.dearchivate("arc",TEST_DIR_PATH + "Text2.txt.arc", TEST_DIR_PATH+"Text2.arc.txt");
    }
}
